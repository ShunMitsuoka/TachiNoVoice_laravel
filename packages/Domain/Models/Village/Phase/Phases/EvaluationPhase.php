...
class EvaluationPhase extends VillagePhase
{
    ...
    function __construct(
        ...
        $this->end_setting_info = new EndSettingInfo(
            ...
            new VillagePhaseSettingItem(
                true, '全員が評価した場合終了する。', $this->getEndSetting($phase_end_setting)->byLimitFlg()
            )
        );
    }
}