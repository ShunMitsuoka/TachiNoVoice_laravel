...
class AskingOpinionsOfRiseMemberPhase extends VillagePhase
{
    ...
    function __construct(
        ...
        if($phase_no !== self::PHASE_ASKING_OPINIONS_OF_RIZE_MEMBER){
            throw new \Exception("異なるフェーズが設定されました。", 1);
        }
        parent::__construct($id, $phase_no, $phase_status, null, $phase_end_setting);
        $this->phase_name = self::PHASE_ASKING_OPINIONS_OF_RIZE_MEMBER_NAME;
